...
public class MetaData {
    ...
    public static final String AUTHORITY= "com.example.messagecenter.newsprovider";
    //表名
    ...
    public static final class TableMetaData implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.com.example.messagecenter.newsprovider.news";
        // 单一数据的MIME类型字符串应该以vnd.android.cursor.item/开头
        public static final String CONTENT_TYPE_ITME = "vnd.android.cursor.item/vnd.com.example.messagecenter.newsprovider.news";
        ...
        static {
            ...
            uriMatcher.addURI(MetaData.AUTHORITY, "news", NEWS);
            // 如果match()方法匹配content://com.example.messagecenter.newsprovider/news/1,路径，返回匹配码为NEW
            uriMatcher.addURI(MetaData.AUTHORITY, "news/#", NEW);
        }
    }
}
